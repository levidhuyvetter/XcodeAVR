...
#define HAVE_cpymem_qi 1
#define HAVE_cpymem_hi 1
#define HAVE_cpymemx_qi 1
#define HAVE_cpymemx_hi 1
...
#define HAVE_gasisr (avr_gasisr_prologues)
...
extern rtx        gen_cpymem_qi                      (rtx, rtx, rtx);
extern rtx        gen_cpymem_hi                      (rtx, rtx, rtx);
extern rtx        gen_cpymemx_qi                     (rtx, rtx);
extern rtx        gen_cpymemx_hi                     (rtx, rtx);
...
extern rtx        gen_cpymemhi                       (rtx, rtx, rtx, rtx);
