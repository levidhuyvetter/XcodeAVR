...
#endif
  E_PSImode,               /* config/avr/avr-modes.def:19 */
#define HAVE_PSImode
#ifdef USE_ENUM_MODES
#define PSImode E_PSImode
#else
#define PSImode (scalar_int_mode ((scalar_int_mode::from_int) E_PSImode))
#endif
...
#endif
  E_CPSImode,              /* machmode.def:262 */
#define HAVE_CPSImode
#ifdef USE_ENUM_MODES
#define CPSImode E_CPSImode
#else
#define CPSImode (complex_mode ((complex_mode::from_int) E_CPSImode))
#endif
