...
#endif
#ifdef GENERATOR_FILE
extern int avr_double;
#else
  int x_avr_double;
#define avr_double global_options.x_avr_double
#endif
#ifdef GENERATOR_FILE
extern int avr_gasisr_prologues;
#else
  int x_avr_gasisr_prologues;
#define avr_gasisr_prologues global_options.x_avr_gasisr_prologues
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int avr_long_double;
#else
  int x_avr_long_double;
#define avr_long_double global_options.x_avr_long_double
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifndef GENERATOR_FILE
  int x_VAR_nodevicespecs;
#define x_VAR_nodevicespecs do_not_use
#endif
#ifndef GENERATOR_FILE
...
#define MASK_MAIN_IS_OS_TASK (1U << 6)
#define MASK_NO_INTERRUPTS (1U << 7)
#define MASK_ORDER_1 (1U << 8)
#define MASK_ORDER_2 (1U << 9)
#define MASK_RMW (1U << 10)
#define MASK_SHORT_CALLS (1U << 11)
#define MASK_SKIP_BUG (1U << 12)
#define MASK_TINY_STACK (1U << 13)
...
#define TARGET_MAIN_IS_OS_TASK ((target_flags & MASK_MAIN_IS_OS_TASK) != 0)
#define TARGET_MAIN_IS_OS_TASK_P(target_flags) (((target_flags) & MASK_MAIN_IS_OS_TASK) != 0)
...
enum opt_code
{
  ...
  OPT_Waddr_space_convert = 388,             /* -Waddr-space-convert */
  ...
  OPT_Wmisspelled_isr = 576,                 /* -Wmisspelled-isr */
  OPT_Wmudflap = 577,                        /* -Wmudflap */
  OPT_Wmultichar = 578,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 579,           /* -Wmultiple-inheritance */
  OPT_Wmultistatement_macros = 580,          /* -Wmultistatement-macros */
  OPT_Wnamespaces = 581,                     /* -Wnamespaces */
  OPT_Wnarrowing = 582,                      /* -Wnarrowing */
  OPT_Wnested_externs = 583,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 584, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 585, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_frame_larger_than = 586, */     /* -Wno-frame-larger-than */
  /* OPT_Wno_larger_than = 587, */           /* -Wno-larger-than */
  /* OPT_Wno_stack_usage = 588, */           /* -Wno-stack-usage */
  /* OPT_Wno_vla_larger_than = 589, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 590,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 591,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 592,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 593,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 594,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 595,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 596, */               /* -Wnormalized */
  OPT_Wnormalized_ = 597,                    /* -Wnormalized= */
  OPT_Wnull_dereference = 598,               /* -Wnull-dereference */
  OPT_Wodr = 599,                            /* -Wodr */
  OPT_Wold_style_cast = 600,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 601,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 602,           /* -Wold-style-definition */
  OPT_Wopenmp_simd = 603,                    /* -Wopenmp-simd */
  OPT_Woverflow = 604,                       /* -Woverflow */
  OPT_Woverlength_strings = 605,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 606,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 607,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 608,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 609,            /* -Woverwrite-recursive */
  OPT_Wp_ = 610,                             /* -Wp, */
  OPT_Wpacked = 611,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 612,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 613,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 614,                         /* -Wpadded */
  OPT_Wparentheses = 615,                    /* -Wparentheses */
  OPT_Wpedantic = 616,                       /* -Wpedantic */
  OPT_Wpessimizing_move = 617,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 618, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 619,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 620,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 621,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 622,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 623,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 624,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 625,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 626,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 627,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 628,                       /* -Wprotocol */
  OPT_Wpsabi = 629,                          /* -Wpsabi */
  OPT_Wreal_q_constant = 630,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 631,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 632,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 633,                /* -Wredundant-decls */
  OPT_Wredundant_move = 634,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 635,                 /* -Wredundant-tags */
  OPT_Wregister = 636,                       /* -Wregister */
  OPT_Wreorder = 637,                        /* -Wreorder */
  OPT_Wrestrict = 638,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 639,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 640,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 641,           /* -Wscalar-storage-order */
  OPT_Wselector = 642,                       /* -Wselector */
  OPT_Wsequence_point = 643,                 /* -Wsequence-point */
  OPT_Wshadow = 644,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 645, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 646,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 647, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 648,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 649, */            /* -Wshadow=global */
  OPT_Wshadow_local = 650,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 651,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 652,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 653,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 654, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 655,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 656,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 657,                /* -Wsign-conversion */
  OPT_Wsign_promo = 658,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 659,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 660,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_pointer_div = 661,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 662,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 663,                    /* -Wspeculative */
  OPT_Wstack_protector = 664,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 665,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 666,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 667,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 668,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 669,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 670,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 671,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 672,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 673,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 674, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 675,             /* -Wstringop-overflow= */
  OPT_Wstringop_truncation = 676,            /* -Wstringop-truncation */
  OPT_Wsubobject_linkage = 677,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 678,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 679,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 680,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 681,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 682,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 683,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 684,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 685,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 686,               /* -Wsuggest-override */
  OPT_Wsurprising = 687,                     /* -Wsurprising */
  OPT_Wswitch = 688,                         /* -Wswitch */
  OPT_Wswitch_bool = 689,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 690,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 691,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 692,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 693,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 694,                      /* -Wsync-nand */
  OPT_Wsynth = 695,                          /* -Wsynth */
  OPT_Wsystem_headers = 696,                 /* -Wsystem-headers */
  OPT_Wtabs = 697,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 698,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 699,           /* -Wtautological-compare */
  OPT_Wtemplates = 700,                      /* -Wtemplates */
  OPT_Wterminate = 701,                      /* -Wterminate */
  OPT_Wtraditional = 702,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 703,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 704,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 705,                      /* -Wtrigraphs */
  OPT_Wtype_limits = 706,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 707,            /* -Wundeclared-selector */
  OPT_Wundef = 708,                          /* -Wundef */
  OPT_Wundefined_do_loop = 709,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 710,                      /* -Wunderflow */
  OPT_Wuninitialized = 711,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 712,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 713, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 714, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 715,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 716,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 717,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 718,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 719, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 720,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 721,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 722,                /* -Wunused-function */
  OPT_Wunused_label = 723,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 724,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 725,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 726,               /* -Wunused-parameter */
  OPT_Wunused_result = 727,                  /* -Wunused-result */
  OPT_Wunused_value = 728,                   /* -Wunused-value */
  OPT_Wunused_variable = 729,                /* -Wunused-variable */
  OPT_Wuse_without_only = 730,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 731,                   /* -Wuseless-cast */
  OPT_Wvarargs = 732,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 733,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 734,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 735,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 736,            /* -Wvirtual-move-assign */
  OPT_Wvla = 737,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 738,               /* -Wvla-larger-than= */
  OPT_Wvolatile = 739,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 740,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 741,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 742,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 743,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 744,                       /* -Wzerotrip */
  OPT_X = 745,                               /* -X */
  OPT_Xassembler = 746,                      /* -Xassembler */
  OPT_Xf = 747,                              /* -Xf */
  OPT_Xlinker = 748,                         /* -Xlinker */
  OPT_Xpreprocessor = 749,                   /* -Xpreprocessor */
  OPT_Z = 750,                               /* -Z */
  OPT_ansi = 751,                            /* -ansi */
  OPT_aux_info = 752,                        /* -aux-info */
  /* OPT_aux_info_ = 753, */                 /* -aux-info= */
  OPT_auxbase = 754,                         /* -auxbase */
  OPT_auxbase_strip = 755,                   /* -auxbase-strip */
  OPT_c = 756,                               /* -c */
  OPT_callgraph = 757,                       /* -callgraph */
  OPT_coverage = 758,                        /* -coverage */
  OPT_cpp = 759,                             /* -cpp */
  OPT_cpp_ = 760,                            /* -cpp= */
  OPT_d = 761,                               /* -d */
  OPT_debuglib_ = 762,                       /* -debuglib= */
  OPT_defaultlib_ = 763,                     /* -defaultlib= */
  OPT_defined_only = 764,                    /* -defined-only */
  OPT_demangle = 765,                        /* -demangle */
  OPT_dstartfiles = 766,                     /* -dstartfiles */
  OPT_dump_body_ = 767,                      /* -dump-body= */
  OPT_dump_level_ = 768,                     /* -dump-level= */
  OPT_dumpbase = 769,                        /* -dumpbase */
  OPT_dumpdir = 770,                         /* -dumpdir */
  OPT_dumpfullversion = 771,                 /* -dumpfullversion */
  OPT_dumpmachine = 772,                     /* -dumpmachine */
  OPT_dumpspecs = 773,                       /* -dumpspecs */
  OPT_dumpversion = 774,                     /* -dumpversion */
  OPT_e = 775,                               /* -e */
  OPT_export_dynamic = 776,                  /* -export-dynamic */
  OPT_fPIC = 777,                            /* -fPIC */
  OPT_fPIE = 778,                            /* -fPIE */
  OPT_fRTS_ = 779,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 780,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 781,                   /* -fabi-version= */
  OPT_faccess_control = 782,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 783,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 784,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 785,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 786,                  /* -falign-commons */
  OPT_falign_functions = 787,                /* -falign-functions */
  OPT_falign_functions_ = 788,               /* -falign-functions= */
  OPT_falign_jumps = 789,                    /* -falign-jumps */
  OPT_falign_jumps_ = 790,                   /* -falign-jumps= */
  OPT_falign_labels = 791,                   /* -falign-labels */
  OPT_falign_labels_ = 792,                  /* -falign-labels= */
  OPT_falign_loops = 793,                    /* -falign-loops */
  OPT_falign_loops_ = 794,                   /* -falign-loops= */
  /* OPT_faligned_new = 795, */              /* -faligned-new */
  OPT_faligned_new_ = 796,                   /* -faligned-new= */
  OPT_fall_instantiations = 797,             /* -fall-instantiations */
  OPT_fall_intrinsics = 798,                 /* -fall-intrinsics */
  OPT_fall_virtual = 799,                    /* -fall-virtual */
  OPT_fallocation_dce = 800,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 801,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 802,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 803,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 804,/* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 805,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 806,         /* -falt-external-templates */
  OPT_fanalyzer = 807,                       /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 808,        /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 809,              /* -fanalyzer-checker= */
  OPT_fanalyzer_fine_grained = 810,          /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 811,  /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_state_merge = 812,           /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 813,           /* -fanalyzer-state-purge */
  OPT_fanalyzer_transitivity = 814,          /* -fanalyzer-transitivity */
  OPT_fanalyzer_verbose_edges = 815,         /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 816, /* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 817,            /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 818, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 819, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 820, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 821, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 822,            /* -fasan-shadow-offset= */
  OPT_fasm = 823,                            /* -fasm */
  OPT_fassert = 824,                         /* -fassert */
  OPT_fassociative_math = 825,               /* -fassociative-math */
  OPT_fassume_phsa = 826,                    /* -fassume-phsa */
  OPT_fasynchronous_unwind_tables = 827,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 828,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 829,                   /* -fauto-profile */
  OPT_fauto_profile_ = 830,                  /* -fauto-profile= */
  OPT_fautomatic = 831,                      /* -fautomatic */
  OPT_fbackslash = 832,                      /* -fbackslash */
  OPT_fbacktrace = 833,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 834,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 835,                   /* -fbounds-check */
  OPT_fbounds_check_ = 836,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 837,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 838,           /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 839, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 840, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 841, */         /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 842,                /* -fbuilding-libgcc */
  OPT_fbuilding_libphobos_tests = 843,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 844,                        /* -fbuiltin */
  OPT_fbuiltin_ = 845,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 846,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 847,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 848,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 849,                    /* -fcall-saved- */
  OPT_fcall_used_ = 850,                     /* -fcall-used- */
  OPT_fcaller_saves = 851,                   /* -fcaller-saves */
  OPT_fcallgraph_info = 852,                 /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 853,                /* -fcallgraph-info= */
  OPT_fcanonical_system_headers = 854,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 855, */            /* -fcf-protection */
  OPT_fcf_protection_ = 856,                 /* -fcf-protection= */
  OPT_fchar8_t = 857,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 858,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 859, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 860,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 861,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 862,                         /* -fcheck= */
  OPT_fchecking = 863,                       /* -fchecking */
  OPT_fchecking_ = 864,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 865,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 866,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 867,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 868,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 869,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 870,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 871,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 872,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 873, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 874,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 875,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 876,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 877, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 878,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 879,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 880,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 881,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 882,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 883, */                 /* -fcilkplus */
  OPT_fcoarray_ = 884,                       /* -fcoarray= */
  OPT_fcode_hoisting = 885,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 886,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 887,                         /* -fcommon */
  OPT_fcompare_debug = 888,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 889,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 890,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 891,                   /* -fcompare-elim */
  OPT_fconcepts = 892,                       /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 893,    /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 894,                    /* -fconcepts-ts */
  OPT_fcond_mismatch = 895,                  /* -fcond-mismatch */
  /* OPT_fconserve_space = 896, */           /* -fconserve-space */
  OPT_fconserve_stack = 897,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 898,         /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 899,         /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 900,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 901,          /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 902,           /* -fconstexpr-ops-limit= */
  OPT_fconvert_ = 903,                       /* -fconvert= */
  OPT_fcoroutines = 904,                     /* -fcoroutines */
  OPT_fcprop_registers = 905,                /* -fcprop-registers */
  OPT_fcray_pointer = 906,                   /* -fcray-pointer */
  OPT_fcrossjumping = 907,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 908,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 909, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 910,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 911,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 912,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 913,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 914,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 915,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 916,                       /* -fdbg-cnt= */
  OPT_fdce = 917,                            /* -fdce */
  OPT_fdebug = 918,                          /* -fdebug */
  OPT_fdebug_cpp = 919,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 920,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 921,            /* -fdebug-types-section */
  OPT_fdebug_ = 922,                         /* -fdebug= */
  OPT_fdec = 923,                            /* -fdec */
  OPT_fdec_blank_format_item = 924,          /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 925,           /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 926,            /* -fdec-format-defaults */
  OPT_fdec_include = 927,                    /* -fdec-include */
  OPT_fdec_intrinsic_ints = 928,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 929,                       /* -fdec-math */
  OPT_fdec_static = 930,                     /* -fdec-static */
  OPT_fdec_structure = 931,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 932,              /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 933, */         /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 934,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 935, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 936,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 937,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 938,                /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 939,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 940,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 941,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 942,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 943,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 944,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 945,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 946,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 947, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 948,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_format_ = 949,            /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 950,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 951,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 952,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 953,       /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_show_caret = 954,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 955,           /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 956,        /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 957,  /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 958,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 959,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 960,   /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_template_tree = 961, /* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_urls_ = 962,              /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 963,                /* -fdirectives-only */
  OPT_fdisable_ = 964,                       /* -fdisable- */
  OPT_fdoc = 965,                            /* -fdoc */
  OPT_fdoc_dir_ = 966,                       /* -fdoc-dir= */
  OPT_fdoc_file_ = 967,                      /* -fdoc-file= */
  OPT_fdoc_inc_ = 968,                       /* -fdoc-inc= */
  OPT_fdollar_ok = 969,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 970,         /* -fdollars-in-identifiers */
  OPT_fdruntime = 971,                       /* -fdruntime */
  OPT_fdse = 972,                            /* -fdse */
  OPT_fdump_ = 973,                          /* -fdump- */
  OPT_fdump_ada_spec = 974,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 975,             /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 976,                  /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 977,        /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 978,   /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 979,   /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 980, /* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 981, /* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_state_purge = 982,      /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 983,           /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 984,       /* -fdump-analyzer-supergraph */
  /* OPT_fdump_core = 985, */                /* -fdump-core */
  OPT_fdump_d_original = 986,                /* -fdump-d-original */
  OPT_fdump_final_insns = 987,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 988,              /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 989,            /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 990,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 991,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 992,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 993,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 994,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 995, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 996,                    /* -fdump-passes */
  OPT_fdump_scos = 997,                      /* -fdump-scos */
  OPT_fdump_unnumbered = 998,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 999,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1000,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1001,                /* -fearly-inlining */
  OPT_felide_constructors = 1002,            /* -felide-constructors */
  OPT_felide_type = 1003,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1004, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1005,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1006,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1007,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1008,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1009,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1010,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1011,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1012,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1013,                /* -fenum-int-equiv */
  OPT_fexceptions = 1014,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1015,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1016,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1017,       /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 1018,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1019,          /* -fextended-identifiers */
  OPT_fextern_tls_init = 1020,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1021,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1022,            /* -fexternal-templates */
  OPT_ff2c = 1023,                           /* -ff2c */
  OPT_ffast_math = 1024,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1025,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1026,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1027,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1028,              /* -ffinite-math-only */
  OPT_ffixed_ = 1029,                        /* -ffixed- */
  OPT_ffixed_form = 1030,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1031,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1032,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1033,                   /* -ffloat-store */
  OPT_ffor_scope = 1034,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1035, */              /* -fforce-addr */
  OPT_fforward_propagate = 1036,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1037,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1038,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1039,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1040,                     /* -ffpe-trap= */
  OPT_ffree_form = 1041,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1042,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1043,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1044,                  /* -ffreestanding */
  OPT_ffriend_injection = 1045,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1046,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1047,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1048,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1049,             /* -ffunction-sections */
  OPT_fgcse = 1050,                          /* -fgcse */
  OPT_fgcse_after_reload = 1051,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1052,                      /* -fgcse-las */
  OPT_fgcse_lm = 1053,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1054,                       /* -fgcse-sm */
  OPT_fgimple = 1055,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1056,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1057,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1058,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1059,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1060,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1061,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1062,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1063,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1064,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1065,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1066,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1067,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1068,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1069,                      /* -fgo-dump- */
  OPT_fgo_optimize_ = 1070,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1071,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1072,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1073,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1074,                      /* -fgraphite */
  OPT_fgraphite_identity = 1075,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1076,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1077,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1078, */       /* -fhandle-exceptions */
  /* OPT_fhelp = 1079, */                    /* -fhelp */
  /* OPT_fhelp_ = 1080, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1081,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1082,                     /* -fhonor-std */
  OPT_fhosted = 1083,                        /* -fhosted */
  OPT_fhuge_objects = 1084,                  /* -fhuge-objects */
  OPT_fident = 1085,                         /* -fident */
  OPT_fif_conversion = 1086,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1087,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1088,        /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 1089,             /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 1090,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1091,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1092,            /* -fimplicit-templates */
  OPT_findirect_inlining = 1093,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1094,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1095,               /* -finit-character= */
  OPT_finit_derived = 1096,                  /* -finit-derived */
  OPT_finit_integer_ = 1097,                 /* -finit-integer= */
  OPT_finit_local_zero = 1098,               /* -finit-local-zero */
  OPT_finit_logical_ = 1099,                 /* -finit-logical= */
  OPT_finit_real_ = 1100,                    /* -finit-real= */
  OPT_finline = 1101,                        /* -finline */
  OPT_finline_arg_packing = 1102,            /* -finline-arg-packing */
  OPT_finline_atomics = 1103,                /* -finline-atomics */
  OPT_finline_functions = 1104,              /* -finline-functions */
  OPT_finline_functions_called_once = 1105,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1106, */           /* -finline-limit- */
  OPT_finline_limit_ = 1107,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1108,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1109,        /* -finline-small-functions */
  OPT_finput_charset_ = 1110,                /* -finput-charset= */
  OPT_finstrument_functions = 1111,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1112,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1113,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 1114,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1115,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1116,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1117,                    /* -finvariants */
  OPT_fipa_bit_cp = 1118,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1119,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1120, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1121,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1122,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1123,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1124,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1125, */        /* -fipa-matrix-reorg */
  OPT_fipa_profile = 1126,                   /* -fipa-profile */
  OPT_fipa_pta = 1127,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1128,                /* -fipa-pure-const */
  OPT_fipa_ra = 1129,                        /* -fipa-ra */
  OPT_fipa_reference = 1130,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1131,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1132,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1133,           /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 1134, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1135,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1136,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1137,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1138,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1139,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1140,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1141,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1142,                  /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 1143,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1144,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1145,              /* -fivar-visibility= */
  OPT_fivopts = 1146,                        /* -fivopts */
  OPT_fjump_tables = 1147,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1148,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1149,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1150,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1151,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1152,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1153,                     /* -flabels-ok */
  OPT_flax_vector_conversions = 1154,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1155,            /* -fleading-underscore */
  OPT_flifetime_dse = 1156,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1157,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1158,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1159,                /* -flinker-output= */
  /* OPT_flive_patching = 1160, */           /* -flive-patching */
  OPT_flive_patching_ = 1161,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1162,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1163,                   /* -flocal-ivars */
  /* OPT_floop_block = 1164, */              /* -floop-block */
  /* OPT_floop_flatten = 1165, */            /* -floop-flatten */
  OPT_floop_interchange = 1166,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1167,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1168, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1169,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1170, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1171,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1172,                     /* -flra-remat */
  OPT_flto = 1173,                           /* -flto */
  OPT_flto_compression_level_ = 1174,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1175, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1176,                /* -flto-partition= */
  OPT_flto_report = 1177,                    /* -flto-report */
  OPT_flto_report_wpa = 1178,                /* -flto-report-wpa */
  OPT_flto_ = 1179,                          /* -flto= */
  OPT_fltrans = 1180,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1181,           /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 1182,             /* -fmacro-prefix-map= */
  OPT_fmain = 1183,                          /* -fmain */
  OPT_fmath_errno = 1184,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1185,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1186,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1187,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1188,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1189,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1190,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1191,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1192,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1193,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1194,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1195,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1196,               /* -fmessage-length= */
  OPT_fmodule_file_ = 1197,                  /* -fmodule-file= */
  OPT_fmodule_private = 1198,                /* -fmodule-private */
  OPT_fmoduleinfo = 1199,                    /* -fmoduleinfo */
  OPT_fmodulo_sched = 1200,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1201,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1202,          /* -fmove-loop-invariants */
  OPT_fms_extensions = 1203,                 /* -fms-extensions */
  OPT_fmudflap = 1204,                       /* -fmudflap */
  OPT_fmudflapir = 1205,                     /* -fmudflapir */
  OPT_fmudflapth = 1206,                     /* -fmudflapth */
  OPT_fname_mangling_version_ = 1207,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1208,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1209,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1210,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1211,                  /* -fnext-runtime */
  OPT_fnil_receivers = 1212,                 /* -fnil-receivers */
  OPT_fnon_call_exceptions = 1213,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1214,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1215,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1216,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1217,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1218,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1219,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1220,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1221,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1222,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1223,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1224,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1225,                  /* -foffload-abi= */
  OPT_foffload_ = 1226,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1227,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1228,                         /* -fonly= */
  OPT_fopenacc = 1229,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1230,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1231,                        /* -fopenmp */
  OPT_fopenmp_simd = 1232,                   /* -fopenmp-simd */
  OPT_foperator_names = 1233,                /* -foperator-names */
  OPT_fopt_info = 1234,                      /* -fopt-info */
  OPT_fopt_info_ = 1235,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1236, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1237,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1238,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1239, */          /* -foptional-diags */
  OPT_fpack_derived = 1240,                  /* -fpack-derived */
  OPT_fpack_struct = 1241,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1242,                  /* -fpack-struct= */
  OPT_fpad_source = 1243,                    /* -fpad-source */
  OPT_fpartial_inlining = 1244,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1245,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1246,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1247,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1248,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1249,                    /* -fpeel-loops */
  OPT_fpeephole = 1250,                      /* -fpeephole */
  OPT_fpeephole2 = 1251,                     /* -fpeephole2 */
  OPT_fpermissive = 1252,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1253,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1254,                           /* -fpic */
  OPT_fpie = 1255,                           /* -fpie */
  OPT_fplan9_extensions = 1256,              /* -fplan9-extensions */
  OPT_fplt = 1257,                           /* -fplt */
  OPT_fplugin_arg_ = 1258,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1259,                       /* -fplugin= */
  OPT_fpost_ipa_mem_report = 1260,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1261,                /* -fpostconditions */
  OPT_fpre_include_ = 1262,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1263,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1264,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1265,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1266,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1267,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1268,              /* -fpretty-templates */
  OPT_fprintf_return_value = 1269,           /* -fprintf-return-value */
  OPT_fprofile = 1270,                       /* -fprofile */
  OPT_fprofile_abs_path = 1271,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1272,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1273,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1274,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1275,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1276,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1277,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1278,             /* -fprofile-generate= */
  OPT_fprofile_note_ = 1279,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1280,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_path_ = 1281,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1282,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1283,                /* -fprofile-report */
  OPT_fprofile_reproducible = 1284,          /* -fprofile-reproducible */
  OPT_fprofile_update_ = 1285,               /* -fprofile-update= */
  OPT_fprofile_use = 1286,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1287,                  /* -fprofile-use= */
  OPT_fprofile_values = 1288,                /* -fprofile-values */
  OPT_fprotect_parens = 1289,                /* -fprotect-parens */
  OPT_frandom_seed = 1290,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1291,                  /* -frandom-seed= */
  OPT_frange_check = 1292,                   /* -frange-check */
  OPT_freal_4_real_10 = 1293,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1294,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1295,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1296,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1297,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1298,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1299,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1300,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1301,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1302,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1303,               /* -frecord-marker=8 */
  OPT_frecursive = 1304,                     /* -frecursive */
  OPT_free = 1305,                           /* -free */
  OPT_freg_struct_return = 1306,             /* -freg-struct-return */
  /* OPT_fregmove = 1307, */                 /* -fregmove */
  OPT_frelease = 1308,                       /* -frelease */
  OPT_frename_registers = 1309,              /* -frename-registers */
  OPT_freorder_blocks = 1310,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1311,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1312,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1313,             /* -freorder-functions */
  OPT_frepack_arrays = 1314,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1315,          /* -freplace-objc-classes */
  OPT_frepo = 1316,                          /* -frepo */
  OPT_freport_bug = 1317,                    /* -freport-bug */
  OPT_frequire_return_statement = 1318,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1319,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1320, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1321,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1322,                   /* -fresolution= */
  OPT_frounding_math = 1323,                 /* -frounding-math */
  OPT_frtti = 1324,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1325,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1326,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1327,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1328,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1329,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1330,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1331,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1332,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1333, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1334,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1335,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1336,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1337,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1338,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1339,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1340,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1341,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1342,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1343,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1344,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1345,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1346,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1347,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1348,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1349,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1350, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1351,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1352,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1353,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1354,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1355,               /* -fsection-anchors */
  /* OPT_fsee = 1356, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1357,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1358,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1359,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1360,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1361,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1362,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1363,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1364,                   /* -fshort-enums */
  OPT_fshort_wchar = 1365,                   /* -fshort-wchar */
  OPT_fshow_column = 1366,                   /* -fshow-column */
  OPT_fshrink_wrap = 1367,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1368,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1369,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1370,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1371,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1372,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1373,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1374,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1375,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1376,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1377,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1378,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1379,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1380,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1381,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1382,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1383,                      /* -fsquangle */
  OPT_fssa_backprop = 1384,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1385,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1386,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1387,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1388, */             /* -fstack-check */
  OPT_fstack_check_ = 1389,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1390,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1391,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1392,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1393,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1394,               /* -fstack-protector */
  OPT_fstack_protector_all = 1395,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1396,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1397,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1398,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1399,                   /* -fstack-usage */
  OPT_fstats = 1400,                         /* -fstats */
  OPT_fstdarg_opt = 1401,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1402,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1403, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1404,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1405,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1406,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1407,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1408,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1409, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1410,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1411,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1412,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1413,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1414,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1415, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1416,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1417, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1418,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1419, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1420,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1421,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1422,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1423,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1424,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1425,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1426,                   /* -ftime-report */
  OPT_ftime_report_details = 1427,           /* -ftime-report-details */
  OPT_ftls_model_ = 1428,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1429,              /* -ftoplevel-reorder */
  OPT_ftracer = 1430,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1431,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1432,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1433,                   /* -ftrampolines */
  OPT_ftransition_all = 1434,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1435,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1436,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1437,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1438,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1439,              /* -ftransition=field */
  OPT_ftransition_import = 1440,             /* -ftransition=import */
  OPT_ftransition_nogc = 1441,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1442,                /* -ftransition=tls */
  OPT_ftrapping_math = 1443,                 /* -ftrapping-math */
  OPT_ftrapv = 1444,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1445,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1446,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1447,                      /* -ftree-ccp */
  OPT_ftree_ch = 1448,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1449, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1450,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1451,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1452, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1453,                   /* -ftree-cselim */
  OPT_ftree_dce = 1454,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1455,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1456,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1457,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1458,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1459, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1460,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1461,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1462, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1463,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1464,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1465, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1466,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1467,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1468,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1469,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1470,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1471,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1472,                      /* -ftree-pre */
  OPT_ftree_pta = 1473,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1474,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1475, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1476,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1477,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1478,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1479,                     /* -ftree-slsr */
  OPT_ftree_sra = 1480,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1481, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1482, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1483,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1484,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1485,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1486, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1487,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1488, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1489,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1490,         /* -funconstrained-commons */
  OPT_funderscoring = 1491,                  /* -funderscoring */
  OPT_funit_at_a_time = 1492,                /* -funit-at-a-time */
  OPT_funittest = 1493,                      /* -funittest */
  OPT_funroll_all_loops = 1494,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1495,   /* -funroll-completely-grow-size */
  ...
  OPT_list = 1597,                           /* -list */
  OPT_mabsdata = 1598,                       /* -mabsdata */
  OPT_maccumulate_args = 1599,               /* -maccumulate-args */
  OPT_mbranch_cost_ = 1600,                  /* -mbranch-cost= */
  OPT_mcall_prologues = 1601,                /* -mcall-prologues */
  OPT_mdeb = 1602,                           /* -mdeb */
  OPT_mdouble_ = 1603,                       /* -mdouble= */
  OPT_mfract_convert_truncate = 1604,        /* -mfract-convert-truncate */
  OPT_mgas_isr_prologues = 1605,             /* -mgas-isr-prologues */
  OPT_mint8 = 1606,                          /* -mint8 */
  OPT_mlog_ = 1607,                          /* -mlog= */
  OPT_mlong_double_ = 1608,                  /* -mlong-double= */
  OPT_mmain_is_OS_task = 1609,               /* -mmain-is-OS_task */
  OPT_mmcu_ = 1610,                          /* -mmcu= */
  OPT_mn_flash_ = 1611,                      /* -mn-flash= */
  OPT_mno_interrupts = 1612,                 /* -mno-interrupts */
  OPT_morder1 = 1613,                        /* -morder1 */
  OPT_morder2 = 1614,                        /* -morder2 */
  OPT_mpmem_wrap_around = 1615,              /* -mpmem-wrap-around */
  OPT_mrelax = 1616,                         /* -mrelax */
  OPT_mrmw = 1617,                           /* -mrmw */
  OPT_mshort_calls = 1618,                   /* -mshort-calls */
  OPT_mskip_bug = 1619,                      /* -mskip-bug */
  OPT_msp8 = 1620,                           /* -msp8 */
  OPT_mstrict_X = 1621,                      /* -mstrict-X */
  OPT_mtiny_stack = 1622,                    /* -mtiny-stack */
  OPT_n = 1623,                              /* -n */
  OPT_name_sort = 1624,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1625,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1626,              /* -no-integrated-cpp */
  OPT_no_pie = 1627,                         /* -no-pie */
  OPT_nocpp = 1628,                          /* -nocpp */
  OPT_nodefaultlibs = 1629,                  /* -nodefaultlibs */
  OPT_nodevicelib = 1630,                    /* -nodevicelib */
  OPT_nodevicespecs = 1631,                  /* -nodevicespecs */
  OPT_nolibc = 1632,                         /* -nolibc */
  OPT_nophoboslib = 1633,                    /* -nophoboslib */
  OPT_nostartfiles = 1634,                   /* -nostartfiles */
  OPT_nostdinc = 1635,                       /* -nostdinc */
  OPT_nostdinc__ = 1636,                     /* -nostdinc++ */
  OPT_nostdlib = 1637,                       /* -nostdlib */
  OPT_o = 1638,                              /* -o */
  OPT_objects = 1639,                        /* -objects */
  OPT_p = 1640,                              /* -p */
  OPT_pass_exit_codes = 1641,                /* -pass-exit-codes */
  /* OPT_pedantic = 1642, */                 /* -pedantic */
  OPT_pedantic_errors = 1643,                /* -pedantic-errors */
  OPT_pg = 1644,                             /* -pg */
  OPT_pie = 1645,                            /* -pie */
  OPT_pipe = 1646,                           /* -pipe */
  OPT_print_file_name_ = 1647,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1648,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1649,          /* -print-multi-directory */
  OPT_print_multi_lib = 1650,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1651,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1652,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1653,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1654,               /* -print-prog-name= */
  OPT_print_search_dirs = 1655,              /* -print-search-dirs */
  OPT_print_sysroot = 1656,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1657,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1658,                    /* -print-value */
  OPT_quiet = 1659,                          /* -quiet */
  OPT_r = 1660,                              /* -r */
  OPT_remap = 1661,                          /* -remap */
  OPT_reverse_sort = 1662,                   /* -reverse-sort */
  OPT_s = 1663,                              /* -s */
  OPT_save_temps = 1664,                     /* -save-temps */
  OPT_save_temps_ = 1665,                    /* -save-temps= */
  OPT_shared = 1666,                         /* -shared */
  OPT_shared_libgcc = 1667,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1668,               /* -shared-libphobos */
  OPT_size_sort = 1669,                      /* -size-sort */
  /* OPT_specs = 1670, */                    /* -specs */
  OPT_specs_ = 1671,                         /* -specs= */
  OPT_static = 1672,                         /* -static */
  OPT_static_libasan = 1673,                 /* -static-libasan */
  OPT_static_libgcc = 1674,                  /* -static-libgcc */
  OPT_static_libgfortran = 1675,             /* -static-libgfortran */
  OPT_static_libgo = 1676,                   /* -static-libgo */
  OPT_static_liblsan = 1677,                 /* -static-liblsan */
  OPT_static_libmpx = 1678,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1679,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1680,               /* -static-libphobos */
  OPT_static_libstdc__ = 1681,               /* -static-libstdc++ */
  OPT_static_libtsan = 1682,                 /* -static-libtsan */
  OPT_static_libubsan = 1683,                /* -static-libubsan */
  OPT_static_pie = 1684,                     /* -static-pie */
  /* OPT_std_c__03 = 1685, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1686, */                /* -std=c++0x */
  OPT_std_c__11 = 1687,                      /* -std=c++11 */
  OPT_std_c__14 = 1688,                      /* -std=c++14 */
  OPT_std_c__17 = 1689,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1690, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1691, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1692, */                /* -std=c++20 */
  OPT_std_c__2a = 1693,                      /* -std=c++2a */
  OPT_std_c__98 = 1694,                      /* -std=c++98 */
  OPT_std_c11 = 1695,                        /* -std=c11 */
  OPT_std_c17 = 1696,                        /* -std=c17 */
  /* OPT_std_c18 = 1697, */                  /* -std=c18 */
  /* OPT_std_c1x = 1698, */                  /* -std=c1x */
  OPT_std_c2x = 1699,                        /* -std=c2x */
  /* OPT_std_c89 = 1700, */                  /* -std=c89 */
  OPT_std_c90 = 1701,                        /* -std=c90 */
  OPT_std_c99 = 1702,                        /* -std=c99 */
  /* OPT_std_c9x = 1703, */                  /* -std=c9x */
  OPT_std_f2003 = 1704,                      /* -std=f2003 */
  OPT_std_f2008 = 1705,                      /* -std=f2008 */
  OPT_std_f2008ts = 1706,                    /* -std=f2008ts */
  OPT_std_f2018 = 1707,                      /* -std=f2018 */
  OPT_std_f95 = 1708,                        /* -std=f95 */
  OPT_std_gnu = 1709,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1710, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1711, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1712,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1713,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1714,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1715, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1716, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1717, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1718,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1719,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1720,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1721,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1722, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1723, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1724,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1725, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1726,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1727,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1728, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1729, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1730,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1731, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1732, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1733, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1734, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1735, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1736,                     /* -std=legacy */
  OPT_symbol_ = 1737,                        /* -symbol= */
  OPT_symbolic = 1738,                       /* -symbolic */
  OPT_t = 1739,                              /* -t */
  OPT_time = 1740,                           /* -time */
  OPT_time_ = 1741,                          /* -time= */
  OPT_traditional = 1742,                    /* -traditional */
  OPT_traditional_cpp = 1743,                /* -traditional-cpp */
  OPT_tree_stats = 1744,                     /* -tree-stats */
  OPT_trigraphs = 1745,                      /* -trigraphs */
  OPT_type_stats = 1746,                     /* -type-stats */
  OPT_u = 1747,                              /* -u */
  OPT_undef = 1748,                          /* -undef */
  OPT_v = 1749,                              /* -v */
  OPT_version = 1750,                        /* -version */
  OPT_w = 1751,                              /* -w */
  OPT_wrapper = 1752,                        /* -wrapper */
  OPT_x = 1753,                              /* -x */
  OPT_z = 1754,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
